...
echo Look for the "IPv4 Address" from "Ethernet adapter vEthernet"
...
echo Enter the "IPv4 Address" from "Ethernet adapter vEthernet" (Default Switch)
echo i.e. "111.11.111.1"
echo "can highlight the entry -> control+c to copy"
echo then right click in the command line to paste or can also manually type.
echo.
